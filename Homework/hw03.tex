...
\caption{CNN Architecture, BN means Batch Normalization, FC means fully connected layer. Global average pooling can be implemented using \texttt{nn.AdaptiveAvgPool2d}}
\label{fig:cnn}
