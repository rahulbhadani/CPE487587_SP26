...
\begin{frame}{Let's do some coding}
    \begin{center}
        \LARGE
        \url{https://github.com/rahulbhadani/CPE490_590_Sp2025/blob/master/Code/Chapter_15_Reinforcement_Learning.ipynb}
    \end{center}
\end{frame}
...
\begin{center}
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.99\textwidth, trim={60 500 60 60}, clip]{figures/Experience_Replay.pdf}};
